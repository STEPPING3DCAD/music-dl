...
The web UI opens in your browser and serves the local music library, search, download, and playback flows. Album search can filter cached Tidal results by quality or content rating, with independent resolution, Atmos, and Explicit badges.
